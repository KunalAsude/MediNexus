...
import { getAppointment, getPrescription, setPatientPrescription, updateAppointment } from "@/lib/actions/appointment.actions"
...
import { emailPrescriptionToPatient, generatePrescriptionPDF } from "@/lib/actions/prescriptionPdfGenerator"
                ...
                <div className="lg:col-span-8 space-y-4 md:space-y-6">
                    ...
                    <Card className="border-none shadow-lg bg-gradient-to-br from-teal-950 to-teal-950">
                        <CardHeader className="bg-gradient-to-r from-teal-950 to-teal-950 pb-3 flex flex-row items-center justify-between">
                            ...
                            <Badge
                                className={`px-2 py-2 ${appointment?.status?.toLowerCase() === "completed"
                                        ...
                                        <div className="flex items-start">
                                            ...
                                            <div className="flex-1">
                                                ...
                                                <div className="flex items-center mt-1 gap-2">
                                                    <p className="text-xs text-teal-300 truncate max-w-[70%] hidden sm:block">{appointment.meetingLink}</p>
                                                    <Button
                                                        variant="ghost"
                                                        size="sm"
